...
public class AudioPlayManager implements SensorEventListener {
    ...
    private OnAudioPlayListener _playListener;
    ...
    public void onSensorChanged(SensorEvent event) {
        synchronized (mLock) {
            ...
            VMLog.d(TAG, "onSensorChanged. range:" + range + "; max range:" + event.sensor.getMaximumRange());
...
//                        mMediaPlayer.setDataSource(fis.getFD());
                        mMediaPlayer.setDataSource(mUriPlaying.toString());
                        ...
                        VMLog.e(TAG, "onSensorChanged " + e);
                    } finally {
                        if (fis != null) {
                            try {
                                fis.close();
                            } catch (IOException e) {
                                VMLog.e(TAG, "startPlay " + e);
                            }
                        }
                    }
...
//    }
    ...
    public void startPlay(final Context context, Uri audioUri, OnAudioPlayListener playListener) {
        synchronized (mLock) {
            if (context == null || audioUri == null) {
                VMLog.e(TAG, "startPlay context or audioUri is null.");
                return;
            }
            mContext = context;
...
//                mMediaPlayer.setDataSource(fis.getFD());
    ...
    public void setPlayListener(OnAudioPlayListener listener) {
        synchronized (mLock) {
        ...
        synchronized (mLock) {
            if (mMediaPlayer != null) {
                try {
                    ...
                    VMLog.e(TAG, "resetMediaPlayer " + e);
                }
            }
        }
    }
